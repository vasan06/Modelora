...
for d in [UPLOAD_DIR, PROCESSED_DIR, ARFF_DIR, EXPORT_DIR, LOG_DIR, CACHE_DIR]:
...
MAX_UNSUPERVISED_ROWS = 3_000
MAX_EXPENSIVE_ALGO_ROWS = 1_000
...
REQUEST_THREADS = int(os.environ.get("REQUEST_THREADS", "8"))
